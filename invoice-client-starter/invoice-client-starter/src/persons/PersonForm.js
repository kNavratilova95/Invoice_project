...
const PersonForm = () => {
    ...
    useEffect(() => {
        if (id) {
            apiGet("/api/persons/" + id).then((data) => setPerson(data)); //load data about person with this id
        }
    }, [id]);
        ...
        <div>
            ...
            {sent && (
                <FlashMessage
                    ...
                    message={success ? "Uložení společnosti proběhlo úspěšně." : "Nastala chyba při ukládání."}
                />
            )}
